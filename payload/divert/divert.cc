// Huge thanks to https://github.com/nbqofficial/divert
#include "divert.h"
...
bool divert::hook(void* function_address, void* hook_address)
{
    ...
    helper::memset_safe(function_address, 0x90, sizeof(shellcode));                         // overwrite original function with nop
    ...
    helper::wpm_safe(function_address, &shellcode, sizeof(shellcode));                      // overwrite the original function with new shellcode
...
bool divert::unhook()
{
    ...
    helper::wpm_safe(function_address, this->original_shellcode, this->original_size);      // restore the original function shellcode
